...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='/project/dmg_data/MMdata/')
    # data/mscoco/imgfeats')
    parser.add_argument('--outdir', type=str, default='/project/dmg_data/MMdata/imgfeats/volta')
    parser.add_argument('--split', type=str, default='trainval', choices=['coco-vist', 'coco', 'vist'])
